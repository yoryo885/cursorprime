  ...
  <style>
    ...
    *,*::before,*::after {{ box-sizing:border-box; margin:0; }}
    ...
    .hero-bg-scrim {{
      ...
      background:linear-gradient(105deg, rgba(250,248,245,0.94) 0%, rgba(250,248,245,0.82) 42%, rgba(250,248,245,0.52) 68%, rgba(250,248,245,0.38) 100%);
    }}
    .hero .wrap {{ position:relative; z-index:1; display:grid; grid-template-columns:1fr 1fr; gap:clamp(24px,5vw,56px); align-items:center; padding-top:clamp(32px,6vw,64px); padding-bottom:clamp(32px,6vw,64px); }}
    .hero-copy {{
      max-width:480px; background:rgba(255,255,255,0.78); backdrop-filter:blur(10px); -webkit-backdrop-filter:blur(10px);
      border:1px solid rgba(232,228,223,0.9); padding:clamp(20px,4vw,28px);
    }}
    ...
    .hero-visual {{
      ...
      border:1px solid rgba(232,228,223,0.9); padding:clamp(16px,3vw,24px);
    }}
    ...
    @media (max-width:768px) {{
      ...
      .hero-bg-scrim {{
        background:linear-gradient(180deg, rgba(250,248,245,0.55) 0%, rgba(250,248,245,0.88) 38%, rgba(250,248,245,0.94) 100%);
      }}
